...
// SANDBAGGED v10.86 — CARD-22: the per-card probe was pricing decks nobody can hold
    ...
    return (
      <div className={skin}>
        <button className="splash" onClick={begin} aria-label="Sandbagged. Tap to begin.">
          ...
          <div className="sfoot">v10.86 · RCJ Labs</div>
        </button>
        <style>{CSS}</style>
      </div>
    )
  ...
  if (st.phase === 'menu') {
    ...
    return (
      <div className={skin}>
        ...
        <div className="center sub" style={{ marginTop: 14 }}>v10.86 · RCJ Labs</div>
        <style>{CSS}</style>
      </div>
    )
  }
