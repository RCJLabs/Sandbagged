...
// SANDBAGGED v10.87 — CARD-23: a firing rate belongs to a deck, not to the game
    ...
    return (
      <div className={skin}>
        <button className="splash" onClick={begin} aria-label="Sandbagged. Tap to begin.">
          ...
          <div className="sfoot">v10.87 · RCJ Labs</div>
        </button>
        <style>{CSS}</style>
      </div>
    )
  ...
  if (st.phase === 'menu') {
    ...
    return (
      <div className={skin}>
        ...
        <div className="center sub" style={{ marginTop: 14 }}>v10.87 · RCJ Labs</div>
        <style>{CSS}</style>
      </div>
    )
  }
