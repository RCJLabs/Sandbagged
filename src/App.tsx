...
// SANDBAGGED v10.88 — HOLD-4: brushing takes the grease off, not the whole wall
    ...
    return (
      <div className={skin}>
        <button className="splash" onClick={begin} aria-label="Sandbagged. Tap to begin.">
          ...
          <div className="sfoot">v10.88 · RCJ Labs</div>
        </button>
        <style>{CSS}</style>
      </div>
    )
  ...
  if (st.phase === 'menu') {
    ...
    return (
      <div className={skin}>
        ...
        <div className="center sub" style={{ marginTop: 14 }}>v10.88 · RCJ Labs</div>
        <style>{CSS}</style>
      </div>
    )
  }
