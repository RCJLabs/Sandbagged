...
// SANDBAGGED v10.89 — ARCH-2: the roster floor is a real number now, and every climber clears it
    ...
    return (
      <div className={skin}>
        <button className="splash" onClick={begin} aria-label="Sandbagged. Tap to begin.">
          ...
          <div className="sfoot">v10.89 · RCJ Labs</div>
        </button>
        <style>{CSS}</style>
      </div>
    )
  ...
  if (st.phase === 'menu') {
    ...
    return (
      <div className={skin}>
        ...
        <div className="center sub" style={{ marginTop: 14 }}>v10.89 · RCJ Labs</div>
        <style>{CSS}</style>
      </div>
    )
  }
