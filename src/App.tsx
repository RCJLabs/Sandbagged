...
// SANDBAGGED v10.85 — SAVE-8: the roster can grow without deleting everyone's decks
    ...
    return (
      <div className={skin}>
        <button className="splash" onClick={begin} aria-label="Sandbagged. Tap to begin.">
          ...
          <div className="sfoot">v10.85 · RCJ Labs</div>
        </button>
        <style>{CSS}</style>
      </div>
    )
  ...
  if (st.phase === 'menu') {
    ...
    return (
      <div className={skin}>
        ...
        <div className="center sub" style={{ marginTop: 14 }}>v10.85 · RCJ Labs</div>
        <style>{CSS}</style>
      </div>
    )
  }
