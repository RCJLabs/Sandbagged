...
// SANDBAGGED v9.97 — ENG-28: a hold's ability is read through abilityOf now —
//   the preview stops shedding a phantom pump and the spotter stops misreading
    ...
    return (
      <div className={skin}>
        <button className="splash" onClick={begin} aria-label="Sandbagged. Tap to begin.">
          ...
          <div className="sfoot">v9.97 · RCJ Labs</div>
        </button>
        <style>{CSS}</style>
      </div>
    )
  ...
  if (st.phase === 'menu') {
    ...
    return (
      <div className={skin}>
        ...
        <div className="center sub" style={{ marginTop: 14 }}>v9.97 · RCJ Labs</div>
        <style>{CSS}</style>
      </div>
    )
  }
