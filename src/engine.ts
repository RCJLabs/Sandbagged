...
/* ============================== TYPES ============================== */
/* ENG-9: the leaf types now live in ./types. They are RE-EXPORTED here, so every existing
   `from './engine'` import keeps working untouched — which is the whole reason this split is
   survivable where v6.6's was not. */
import type { LaneTag, StyleKey, FeetKey, Rarity, Tag, Hold, Card, Piles, Phase, NodeType } from './types'
export type { LaneTag, StyleKey, FeetKey, Fx, Rarity, Tag, Hold, Card, Piles, Phase, NodeType } from './types'
...
/* ENG-9: type-plus-literal content lives in ./content now; every function that reads it
   stayed here. Re-exported so no caller changes. */
...
/* ENG-9: the routes and the events are literal content and live in ./content; their types
